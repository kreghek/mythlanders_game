...
internal class CombatGreekTutorial1PageDrawer : TutorialPageDrawerBase
{
    private readonly ControlBase _content;

    public CombatGreekTutorial1PageDrawer(IUiContentStorage uiContentStorage) : base(uiContentStorage)
    {
        var elements = new[]
        {
            CreateText(uiContentStorage, UiResource.CombatGreekTutorial1Paragraph1)
        };
