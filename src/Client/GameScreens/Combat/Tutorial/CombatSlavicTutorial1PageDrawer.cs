...
internal class CombatSlavicTutorial1PageDrawer : TutorialPageDrawerBase
{
    ...
    public CombatSlavicTutorial1PageDrawer(IUiContentStorage uiContentStorage, Texture2D paragraphImage) : base(uiContentStorage)
    {
        var elements = new[]
        {
            CreateText(uiContentStorage, UiResource.CombatSlavicTutorial1Paragraph1),
            new Image(paragraphImage, paragraphImage.Bounds, uiContentStorage.GetControlBackgroundTexture(), ControlTextures.Transparent),
