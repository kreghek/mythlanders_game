...
[UsedImplicitly]
internal class DopeHerbFactory : CombatMovementFactoryBase
{
    /// <inheritdoc />
        ...
        ICombatMovementVisualizationContext visualizationContext)
    {
        ...
        var shotSoundEffect =
            visualizationContext.GameObjectContentStorage.GetSkillUsageSound(GameObjectSoundType.MagicDust);
