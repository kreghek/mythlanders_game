...
internal sealed class GreenBloodCombatVisualEffect : ICombatVisualEffect
{
    ...
    public GreenBloodCombatVisualEffect(Vector2 position, HitDirection direction, TextureRegion2D bloodParticleTexture)
    {
            ...
            Emitters = new List<ParticleEmitter>
            {
                    ...
                    Profile.Spray(direction == HitDirection.Right ? Vector2.UnitX : -Vector2.UnitX, 1))
                {
                    Parameters = new ParticleReleaseParameters
                    {
                        ...
                        Color = new Range<HslColor>(HslColor.FromRgb(Color.Lime),
                            HslColor.FromRgb(new Color(Color.LimeGreen, 0.5f)))
                    },
                    Modifiers =
                    {
                        new AgeModifier
