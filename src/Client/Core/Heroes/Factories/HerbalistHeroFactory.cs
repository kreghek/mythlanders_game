...
using Client.Assets.CombatMovements.Hero.Herbalist;
...
[UsedImplicitly]
internal sealed class HerbalistHeroFactory : HeroFactoryBase
{
    public override CombatantGraphicsConfigBase GetGraphicsConfig()
    {
        return new HerbalistGraphicsConfig();
    }
    ...
    protected override CombatMovementSequence CreateInitCombatMovementPool()
    {
        ...
        {
            CreateMovement<DopeHerbFactory>(),
