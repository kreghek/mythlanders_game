...
{
    private DamageEffect _innerDamageEffect;

    public DamageEffectWrapper(ITargetSelector selector, DamageType damageType, GenericRange<int> damage)
    {
        _innerDamageEffect = new DamageEffect(selector, damageType, damage, new DamageEffectConfig(CombatantStatTypes.HitPoints, CombatantStatTypes.ShieldPoints, CombatantStatTypes.Defense));
    }
