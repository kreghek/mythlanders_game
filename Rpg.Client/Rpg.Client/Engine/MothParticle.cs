...
namespace Rpg.Client.Engine
{
    ...
    internal class PulseItemParticle : IParticle
    {
        private readonly Rectangle _sourceRect;
        private readonly Vector2 _startPosition;
        private readonly int _startTTL;
        ...
        public PulseItemParticle(Texture2D texture, Rectangle sourceRect, Vector2 position, Vector2 targetPosition,
            Vector2 velocity,
            float angle, float angularVelocity, Color color, float size, int ttl)
        {
            _sourceRect = sourceRect;
        ...
        public void Update()
        {
            ...
            var upVector = Vector2.UnitY * (float)Math.Sin(t * Math.PI * 2) * 0;
            Position = Vector2.Lerp(_startPosition, _targetPosition, t) + upVector;
        }
    }
}