...
namespace Rpg.Client.Models.EndGame
{
    internal sealed class EndGameScreen : GameScreenBase
    {
        ...
        public EndGameScreen(Game game) : base(game)
        {
            ...
            _backButton = new TextButton("Back", _uiContentStorage.GetButtonTexture(), _uiContentStorage.GetMainFont(), Rectangle.Empty);
        ...
        {
            spriteBatch.Begin();
            spriteBatch.DrawString(_uiContentStorage.GetMainFont(), "Happy end! Or not?", new Vector2(100, 100), Color.White);
